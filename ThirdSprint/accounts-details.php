...
<body>
    ...
    <p class="cosmic-message"><?php echo $cosmic_message; ?></p>
        ...
        if ($row = pg_fetch_assoc($result)) {
            ...
            echo "<p><strong>Subcategory:</strong> " . htmlspecialchars($row['account_subcategory']) . "</p>";
        ...
        pg_close($dbconn);
        error_log($row['account_subcategory']);
        ?>
        <p><a href="accounts-view.php">Back to All Accounts</a></p>
    </main>
    <div class="booties"><a href="help.php" class="help-button">Need help?</a> </div> <a href="mail-page.php" class="help-button">Email</a>
</body>
</html>
